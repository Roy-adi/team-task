              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-70">
                   Log in in to your account to continue your Team journey
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button type="submit" className="btn btn-primary w-full" disabled={isPending} style={{ background: '#FFC727'}}>
                    {isPending ? (
                      <>
                  ...
                  onClick={handleGooglelogin} style={{ background: '#FFC727'}}
                >
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            ...
            <div className="text-center space-y-3 mt-6">
              <h2 className="text-xl font-semibold">Connect with Your team</h2>
