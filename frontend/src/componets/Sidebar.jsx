    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          {/* Logo/Brand */}
          <div
            className={`flex items-center justify-between p-6 border-b border-base-300 ${
              collapsed ? "lg:px-4" : ""
            }`}
          >
            <Link
              ...
              className={`flex items-center space-x-3 transition-all duration-300 ${
                collapsed ? "lg:justify-center lg:space-x-0" : ""
              }`}
              onClick={onClose}
            >
              <div className="w-10 h-10 bg-primary rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md">
                <Globe className="w-5 h-5 text-primary-content" />
              </div>
              ...
              return (
                <Link
                  ...
                  className={`
                    ...
                    ${
                      collapsed
                        ? "lg:justify-center lg:px-4 lg:py-3"
                        : "space-x-3 px-4 py-3"
                    }
                    ${
                      isActive
